...
const mealDays = Object.fromEntries(
  Object.entries(mealsByDate).map(([date, mealList]) => [date, mealList.length])
);
...
const mealDayEntries = Object.entries(mealDays)
  ...
  .filter(({ dateObj }) => dateObj.getMonth() === visibleMonth && dateObj.getFullYear() === visibleYear)
  ...
  //week view 
    ...
    <div className="container-fluid mt-4 px-5">
      ...
      <div className="d-flex justify-content-between align-items-center mb-3">
        <ButtonGroup size="sm">
          <Button
            variant={view === "month" ? "view-btn view-btn--active" : "view-btn"}
        ...
        <>
          ...
          <div className="d-flex align-items-center gap-2 mb-3">
            <Button variant="outline-secondary" size="sm" onClick={() => shiftWeek(-1)}>
              &#8592;
            </Button>
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    borderColor: isToday ? "#0d6efd" : undefined,
                    display: "flex",
      ...
      <Modal show={!!selectedMeal} onHide={() => setSelectedMeal(null)} centered>
      ...
      <Modal.Body>
        ...
        <table className="table table-sm table-borderless mb-0">
          <tbody>
              <tr>
                <td className="text-muted" style={{ width: 120 }}>Ingredients</td>
                <td>
        ...
        <Modal.Footer>
          ...
          <Button variant="" className="edit-btn" onClick={() => {
            window.location.href = `/edit-meal/${selectedMeal._id}`;
          }}>
            Edit Meal
          </Button>
          {/* imported delete button */}
            <Button variant="" className="delete-btn" onClick={() => {
          ...
          {/* close button */}
          <Button variant="" className="edit-btn" onClick={() => setSelectedMeal(null)}>
            Close
          </Button>
        </Modal.Footer>
      </Modal>
      ...
      {view === "month" && (
        ...
        <div className="row">
          ...
          <div className="col-lg-7 col-md-12 ">
            <div className="mb-4 shadow-lg rounded border p-3  list-table" 
              style={{ maxHeight: 300, overflowY: "auto" }}>
              <h4 className="mb-3 text-center ">Days with meals</h4>
              <Table size="sm" striped bordered hover className="mb-0 list-table-headings">
                <thead>
                  <tr>
                    <th>Date</th>
                    <th>Meals</th>
            ...
            <div className="shadow-sm rounded border p-3 list-table" style={{ maxHeight: 300, overflowY: "auto" }}>
